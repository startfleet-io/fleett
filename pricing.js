$(function () {
    ...
    function displayCell(params) {
        ...
        if (params.item.name == 'Address with Electricity Bill') {
            ...
            let cell = `<input class="mr-5 priceBox" type="checkbox" data-plan="${params.plan}" data-price="${price}"  id="${params.item['id']}" data-ref="${params.item['refcode']}" />`;
    ...
    function setStates(state_fess) {
        ...
        let states = _.filter(state_fess, function (sf) {
            return sf.is_show === true;
        });
    ...
    function initWrap() {
        ...
        $.get(API_PRICING, {}, async function (data, textStatus, jqXHR) {
            ...
            badge +=
                '<img src="https://uploads-ssl.webflow.com/60e439b8e0c58b64b4496671/610154cc329673a834f01bed_featured-label-new.svg" loading="lazy" id="img-featured-label" alt="" class="image-21">';
            badge += '</div>';
            ...
            formationItems = await productList.filter(item => item.category == 'formation' && item.is_hide == false);
...
<div class="pricing-table-cell mcell rightcell">
  ...
  ${cruiser}
            ...
            complianceItems = productList.filter(item => item.category == 'compliance' && item.is_hide == false);
      ...
      <div class="pricing-table-cell mcell rightcell">
        ...
        ${cruiser}
            ...
            growthItems = productList.filter(item => item.category == 'growth' && item.is_hide == false);
      ...
      <div class="pricing-table-cell mcell rightcell">
        ...
        ${cruiser}
            ...
            Addons = productList.filter(item => item.category == 'addons' && item.is_hide == false);
    ...
    $('select').on('change', function () {
        ...
        let found = dt.find(function (elm) {
            return elm.structure.toLowerCase() == company.toLowerCase() && elm.state.toLowerCase() == state.toLowerCase();
        });
